...
namespace Umbraco.Tests.Persistence
{
    ...
    public class DatabaseContextTests
    {
        ...
        public void Can_Assert_Created_Database()
        {
            ...
            var dbFactory = new DefaultDatabaseFactory(engine.LocalConnectionString, Constants.DbProviderNames.SqlCe, _sqlSyntaxProviders, _logger, new TestUmbracoDatabaseAccessor(), Mock.Of<IMappingResolver>());
            _dbContext = new DatabaseContext(dbFactory, _logger);
