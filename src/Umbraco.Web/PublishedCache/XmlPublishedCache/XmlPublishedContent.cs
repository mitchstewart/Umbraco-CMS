...
namespace Umbraco.Web.PublishedCache.XmlPublishedCache
{
	...
	internal class XmlPublishedContent : PublishedContentBase
	{
		...
		private void InitializeParent()
		{
		    ...
		    if (parent.Name == "node" || (parent.Attributes?.GetNamedItem("isDoc") != null))
	    ...
	    /// <param name="cacheProvider">A cache provider at facade/request level.</param>
	    ...
	    public static IPublishedContent Get(XmlNode node, bool isPreviewing, ICacheProvider cacheProvider, PublishedContentTypeCache contentTypeCache)
        {
            ...
            return (IPublishedContent) cacheProvider.GetCacheItem(key, () =>
                (new XmlPublishedContent(node, isPreviewing, cacheProvider, contentTypeCache)).CreateModel());
        }
    }
}